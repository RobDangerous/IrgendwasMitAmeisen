...
InstancedMeshObject::InstancedMeshObject(const char* meshFile, const char* textureFile, Graphics4::VertexStructure** structures, int maxCount, float scale) {
	...
	vertexBuffers[0] = new Graphics4::VertexBuffer(mesh->numVertices, *structures[0], Graphics4::StaticUsage, 0);
	...
	vertexBuffers[1] = new Graphics4::VertexBuffer(maxCount, *structures[1], Graphics4::StaticUsage, 1);
